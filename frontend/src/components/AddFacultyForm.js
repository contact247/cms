...
export default function AddFacultyForm({ departments, courses, onFacultyAdded }) {
  ...
  return (
    <>
      <button onClick={() => setShowForm(true)} style={buttonStyle}>+ Add Faculty</button>
      <div style={formStyle}>
        <h2 style={{ marginBottom: '20px' }}>Add New Faculty</h2>
